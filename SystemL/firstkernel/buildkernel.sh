rm boot.o kernel.o gdt_asm.o gdt.o utility.o test.o terminal.o io.o interrupt.o idt_asm.o idt.o isr_asm.o irq_asm.o isr.o irq.o
i686-elf-as -g boot.s -o boot.o
i686-elf-as -g gdt.s -o gdt_asm.o
i686-elf-as -g idt.s -o idt_asm.o
i686-elf-as -g isr.s -o isr_asm.o
...
i686-elf-gcc -g -m32 -c isr.c -o isr.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
i686-elf-gcc -g -m32 -c irq.c -o irq.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
echo "linking..."
i686-elf-gcc -g -m32 -T linker.ld -o systeml.bin -ffreestanding -O2 -nostdlib boot.o kernel.o gdt_asm.o gdt.o utility.o terminal.o test.o io.o interrupt.o idt_asm.o idt.o isr_asm.o isr.o irq_asm.o irq.o -lgcc
./testmultiboot.sh
