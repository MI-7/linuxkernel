rm boot.o kernel.o gdt_asm.o gdt.o utility.o test.o terminal.o io.o interrupt.o idt_asm.o idt.o isr_asm.o irq_asm.o
...
echo "linking..."
i686-elf-gcc -T linker.ld -o systeml.bin -ffreestanding -O2 -nostdlib boot.o kernel.o gdt_asm.o gdt.o utility.o terminal.o test.o io.o interrupt.o idt_asm.o idt.o isr_asm.o -lgcc
./testmultiboot.sh
